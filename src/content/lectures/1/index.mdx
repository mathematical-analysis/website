...
Let $A$ be a subset of $\mathbb{R}$, denoted as $A\subseteq\mathbb{R}$. We define $x\in\mathbb{R}$ to be
	...
	We define		
	$$
	lb(A) := \{ x\in \mathbb{R} \mid x\leq a,\, \forall a\in A\} \text{ the set of lower bounds of } A,
	$$
	$$
	ub(A) := \{ x\in \mathbb{R} \mid x\geq a,\, \forall a\in A\} \text{ the set of upper bounds of } A.
	$$
...
**Definition 1.9**
Define the extended real line \overline $\mathbb{R} := \mathbb{R} \cup \{-\infty,\infty\}$, where $\infty$ and $-\infty$ are such that
$$
...
### Neighborhoods. Interior. Closure 
